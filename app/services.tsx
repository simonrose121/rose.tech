...
export default function Services() {
	return (
		<div className="bg-black py-24 relative isolate sm:py-32 border-t border-b border-white/10">
			<img
				src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80&auto=format&w=2830&q=80&blend=111827&sat=-100&exp=5&blend-mode=multiply"
				alt=""
			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto lg:mx-0 text-center">
					<p className="mt-6 text-lg leading-8 text-white">
						Our expertise keeps your organisation moving forwards.
					</p>
				</div>
