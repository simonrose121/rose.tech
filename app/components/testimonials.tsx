...
export default function Testimonials() {
	const testimonials: Array<Testimonial> = [
		{
			logo: '542 Digital',
			text: `Simon at RoseTech is an exceptional software
		...
		{
			logo: 'MTa Learning',
			text: `RoseTech consistently impressed me with their exceptional technical and soft skills and ability to drive successful projects. Their contributions were invaluable to the success of each project, and the processes implemented by them will carry forward into all future projects, ensuring our continued success.`,
			name: 'Steven Green',
		...
		{
			logo: '542 Digital',
			text: `Simon at RoseTech has been at the forefront of driving innovation and change in the frontend team and 542. His technical prowess is evident in how he moves deftly between frontend React/Typescript (including Next.js), to backend Express.js applications, and configuration of CI/CD pipelines.`,
		...
		},
		{
			...
			text: `RoseTech did a fantastic job on my app. The
		...
		{
			logo: '542 Digital',
			text: `RoseTech distinguishes themselves by effectively using software capabilities and daring to explore and implement viable and innovative solutions that push organizational growth and business success. Their vision, enthusiasm, and relentless determination for transformative software enhancements will be invaluable to any individual, business, or organization.`,
		...
		{
			logo: '542 Digital',
			text: `As a team member and a leader, Simon from RoseTech is insightful, methodical, and flexible. These traits, coupled with immense measures of patience, make him an excellent manager of people, projects, and his own time. Working part-time in a 100% remote environment, I've seen him take the reins on and deliver quick-turnaround projects with cross-team dependencies, as well as implement new company processes over the course of months through consultation with stakeholders from junior to director level and the slow conversion of minds through action.`,
			name: 'Laurie Hayes',
