export default function TermsAndConditions() {
	return (
		<div className="py-24 sm:py-32 mx-auto">
			<div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col mb-12 gap-6 leading-7">
				...
				<p>
					...
					with our privacy policy govern Rose Technologies Limited's
					relationship with you in relation to this website. If you
					disagree with any part of these terms and conditions, please
					do not use our website.
				</p>
				<p>
					The term 'Rose Technologies Limited' or 'us' or 'we' refers
					to the owner of the website whose registered office is 30
					Bannerdale Road, Sheffield, S7 2DL. Our company registration
					number is 13572983. The term 'you' refers to the user or
				...
				<ul className="list-disc pl-6">
					...
					<li>
						...
						following personal information may be stored by us for
						use by third parties: geographical location, browser
					...
					<li>
						...
						such use of the website is subject to the laws of
